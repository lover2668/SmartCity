...
[![](https://img.shields.io/badge/download-demo-blue.svg)](https://raw.githubusercontent.com/JenkinsZhou/FastLib/master/apk/sample.apk)
[![](https://jitpack.io/v/JenkinsZhou/FastLib.svg)](https://jitpack.io/#JenkinsZhou/FastLib)
[![](https://img.shields.io/github/release/JenkinsZhou/FastLib.svg)](https://github.com/JenkinsZhou/FastLib/releases)
[![API](https://img.shields.io/badge/API-15%2B-green.svg?style=flat)](https://android-arsenal.com/api?level=15)
[![GitHub license](https://img.shields.io/github/license/JenkinsZhou/FastLib.svg)](http://www.apache.org/licenses/LICENSE-2.0.html)
[![](https://img.shields.io/badge/简书-JenkinsZhou-blue.svg)](http://www.jianshu.com/u/a229eee96115)
[![](https://img.shields.io/badge/wiki-使用说明-green.svg)](https://github.com/JenkinsZhou/FastLib/wiki)
...
[wiki](https://github.com/JenkinsZhou/FastLib/wiki) 基于**FastLib 2.2.12** 、**Android Studio 3.3.1**、**Gradle 4.10.1**版本编写,后期重大变更会同步更新。
...
其它功能请在demo中发现，详细使用请看[wiki](https://github.com/JenkinsZhou/FastLib/wiki)

[[Download-蒲公英]](https://www.pgyer.com/KmaF)

![Download-蒲公英](/apk/qr_pgyer.png)

[[Download-github]](https://raw.githubusercontent.com/JenkinsZhou/FastLib/dev/apk/sample.apk)
...
2、**2.2.13_beta12以下版本**可参考[proguard-rules.pro](https://github.com/JenkinsZhou/FastLib/blob/dev/library/proguard-rules.pro)

## 重大更新日志 其它版本参看[Release](https://github.com/JenkinsZhou/FastLib/releases)
...
![](https://github.com/JenkinsZhou/FastLib/blob/dev/screenshot/FastRefresh.gif)

**快速实现页面下拉刷新-全局控制及局部个性化**-参考WebActivity、FastRefreshActivity、MineFragment


![](https://github.com/JenkinsZhou/FastLib/blob/master/screenshot/02.gif)

**虚拟导航栏控制**-参考[AppImpl类](/app/src/main/java/com/aries/library/fast/demo/AppImpl.java) NavigationBarControl接口实现注释说明

**模拟器软键盘控制**

![](https://github.com/JenkinsZhou/UIWidget/blob/master/screenshot/keyboard01.gif)

**华为可隐藏软键盘控制**

![](https://github.com/JenkinsZhou/UIWidget/blob/master/screenshot/keyboard02.gif)

**华为全面屏手势控制**

![](https://github.com/JenkinsZhou/UIWidget/blob/master/screenshot/keyboard03.gif)

![](https://github.com/JenkinsZhou/FastLib/blob/master/screenshot/00.gif)

![](https://github.com/JenkinsZhou/FastLib/blob/master/screenshot/01.gif)

**开启GPU过度绘制检测+GPU呈现模式分析**

![](https://github.com/JenkinsZhou/FastLib/blob/master/screenshot/DoraemonKit.gif)
...
```
dependencies {
      implementation 'com.github.JenkinsZhou:FastLib:2.2.13'
}
```
...
```
	<dependency>
	    <groupId>com.github.JenkinsZhou</groupId>
...
dependencies {
    ...
    api 'com.github.JenkinsZhou.UIWidget:widget-core:3.2.9'
    //日志打印
    ...
    //快速Tab库
    api 'com.github.JenkinsZhou:TabLayout:1.0.2'
    //页面事件交互
...
16. [`TabLayout` 是`JenkinsZhou` forked from `FlycoTabLayout`并加以优化调整的主界面tab、滑动tab、分段选择器tab功能库](https://github.com/JenkinsZhou/TabLayout)
17. [`UIWidget` 是`JenkinsZhou` 封装的常用UI库(TitleBarView、RadiusView、StatusViewHelper、NavigationViewHelper等)](https://github.com/JenkinsZhou/UIWidget)
