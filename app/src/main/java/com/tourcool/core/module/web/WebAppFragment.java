package com.tourcool.core.module.web;
...
/**
 * @Author: JenkinsZhou on 2019/4/24 14:36
 * @E-Mail: 971613168@qq.com
 * @Function: 展示WebApp
 * @Description:
 */
public class WebAppFragment extends BaseTitleRefreshLoadFragment<WebAppEntity> {
    ...
    public void loadData(int page) {
        ...
        UiManager.getInstance().getHttpRequestControl().httpRequestSuccess(getIHttpRequestControl(), list, null);
    }
