...
public class OrcSelectActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mScanIdCard:
                ...
                LibraryInitOCR.startScan(OrcSelectActivity.this, bundle);
                break;
            //识别驾驶证
            ...
            case R.id.mScanBankCard:
                Intent intent = new Intent(OrcSelectActivity.this, ScanBankCardActivity.class);
