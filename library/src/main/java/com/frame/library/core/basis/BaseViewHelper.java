...
/**
 * @Author: JenkinsZhou on 2019/6/27 15:29
 * @E-Mail: 971613168@qq.com
 * @Function: 包含View的BasisHelper
 * @Description:
 */
public abstract class BaseViewHelper<T extends BaseViewHelper> extends BaeHelper {

    protected View mContentView;

    public BaseViewHelper(Activity context) {
        super(context);
        getContentView();
    }
