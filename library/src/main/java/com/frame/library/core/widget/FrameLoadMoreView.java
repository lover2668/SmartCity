 ...
 * Description:
 */
public class FrameLoadMoreView extends LoadMoreView {
    ...
    public FrameLoadMoreView(@Nullable Context context) {
        this(new Builder(context));
    }

    FrameLoadMoreView(Builder builder) {
    ...
    public static final class Builder {
        ...
        public Builder(FrameLoadMoreView frameLoadMoreView) {
            this.mContext = frameLoadMoreView.mContext;
            this.mLoadingSize = frameLoadMoreView.mLoadingSize;
            this.mLoadingText = frameLoadMoreView.mLoadingText;
            this.mLoadingTextColor = frameLoadMoreView.mLoadingTextColor;
            this.mLoadingTextSize = frameLoadMoreView.mLoadingTextSize;
            this.mLoadingProgressColor = frameLoadMoreView.mLoadingProgressColor;
            this.mLoadingProgressDrawable = frameLoadMoreView.mLoadingProgressDrawable;
            this.mLoadFailText = frameLoadMoreView.mLoadFailText;
            this.mLoadFailTextColor = frameLoadMoreView.mLoadFailTextColor;
            this.mLoadFailTextSize = frameLoadMoreView.mLoadFailTextSize;
            this.mLoadEndText = frameLoadMoreView.mLoadEndText;
            this.mLoadEndTextColor = frameLoadMoreView.mLoadEndTextColor;
            this.mLoadEndTextSize = frameLoadMoreView.mLoadEndTextSize;
        ...
        public FrameLoadMoreView build() {
            return new FrameLoadMoreView(this);
        }
    }
}
