package com.frame.library.core.widget.linkage;
/*
...
import com.frame.library.core.widget.linkage.bean.DefaultGroupedItem;
...
import com.frame.library.core.widget.linkage.defaults.DefaultLinkagePrimaryAdapterConfig;
import com.frame.library.core.widget.linkage.defaults.DefaultLinkageSecondaryAdapterConfig;
import com.frame.library.core.widget.linkage.manager.RecyclerViewScrollHelper;
...
public class LinkageRecyclerView<T extends BaseGroupedItem.ItemInfo> extends RelativeLayout {
    ...
    private boolean mScrollSmoothly = false;
