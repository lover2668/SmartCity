package com.frame.library.core.widget.linkage.defaults;
/*
...
public class DefaultLinkagePrimaryAdapterConfig implements ILinkagePrimaryAdapterConfig {
    ...
    public void onBindViewHolder(LinkagePrimaryViewHolder holder, boolean selected, String title) {
        ...
        tvTitle.setBackgroundColor(mContext.getResources().getColor(selected ? R.color.green0DBD00 : R.color.colorWhite));
        tvTitle.setTextColor(ContextCompat.getColor(mContext, selected ? R.color.colorWhite : R.color.green0DBD00));
