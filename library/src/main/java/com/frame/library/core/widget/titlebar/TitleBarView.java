...
public class TitleBarView extends ViewGroup {
 public static final String TAG = "TitleBarView";
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, com.aries.ui.widget.R.styleable.TitleBarView);
        mImmersible = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_immersible, true);
        mStatusBarPlusEnable = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_statusBarPlusEnable, true);
        mOutPadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_outPadding, dip2px(DEFAULT_OUT_PADDING));
        mActionPadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_actionPadding, dip2px(2));
        mCenterLayoutPadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_centerLayoutPadding, dip2px(2));
        mCenterGravityLeft = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_centerGravityLeft, false);
        mCenterGravityLeftPadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_centerGravityLeftPadding, dip2px(DEFAULT_CENTER_GRAVITY_LEFT_PADDING));
        mStatusBarLightMode = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_statusBarLightMode, false);
        mViewPressedAlpha = ta.getFloat(com.aries.ui.widget.R.styleable.TitleBarView_title_viewPressedAlpha, mResourceUtil.getAttrFloat(com.aries.ui.widget.R.attr.pressedAlpha));

        mStatusBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_statusBackground);
        mDividerBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_dividerBackground);
        mDividerHeight = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_dividerHeight, dip2px(0.5f));
        mDividerVisible = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_dividerVisible, true);

        mLeftText = ta.getString(com.aries.ui.widget.R.styleable.TitleBarView_title_leftText);
        mLeftTextSize = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextSize, dip2px(DEFAULT_TEXT_SIZE));
        mLeftTextColor = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextColor);
        mLeftTextBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextBackground);
        mLeftTextDrawable = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawable);
        mLeftTextDrawableTint = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawableTint);
        mLeftTextDrawableTintMode = parseTintMode(ta.getInt(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawableTintMode, -1), mLeftTextDrawableTintMode);
        mLeftTextDrawableWidth = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawableWidth, -1);
        mLeftTextDrawableHeight = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawableHeight, -1);
        mLeftTextDrawablePadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_leftTextDrawablePadding, dip2px(1));

        mTitleMainText = ta.getString(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainText);
        mTitleMainTextSize = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainTextSize, dip2px(DEFAULT_MAIN_TEXT_SIZE));
        mTitleMainTextColor = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainTextColor);
        mTitleMainTextBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainTextBackground);
        mTitleMainTextFakeBold = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainTextFakeBold, false);
        mTitleMainTextMarquee = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_titleMainTextMarquee, false);

        mTitleSubText = ta.getString(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubText);
        mTitleSubTextSize = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubTextSize, dip2px(DEFAULT_SUB_TEXT_SIZE));
        mTitleSubTextColor = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubTextColor);
        mTitleSubTextBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubTextBackground);
        mTitleSubTextFakeBold = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubTextFakeBold, false);
        mTitleSubTextMarquee = ta.getBoolean(com.aries.ui.widget.R.styleable.TitleBarView_title_titleSubTextMarquee, false);

        mRightText = ta.getString(com.aries.ui.widget.R.styleable.TitleBarView_title_rightText);
        mRightTextSize = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextSize, dip2px(DEFAULT_TEXT_SIZE));
        mRightTextColor = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextColor);
        mRightTextBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextBackground);
        mRightTextDrawable = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawable);
        mRightTextDrawableTint = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawableTint);
        mRightTextDrawableTintMode = parseTintMode(ta.getInt(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawableTintMode, -1), mRightTextDrawableTintMode);
        mRightTextDrawableWidth = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawableWidth, -1);
        mRightTextDrawableHeight = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawableHeight, -1);
        mRightTextDrawablePadding = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_rightTextDrawablePadding, dip2px(1));

        mActionTextSize = ta.getDimensionPixelSize(com.aries.ui.widget.R.styleable.TitleBarView_title_actionTextSize, dip2px(DEFAULT_TEXT_SIZE));
        mActionTextColor = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_actionTextColor);
        mActionTextBackground = ta.getDrawable(com.aries.ui.widget.R.styleable.TitleBarView_title_actionTextBackground);
        mActionTint = ta.getColorStateList(com.aries.ui.widget.R.styleable.TitleBarView_title_actionTint);
        mActionTintMode = parseTintMode(ta.getInt(com.aries.ui.widget.R.styleable.TitleBarView_title_actionTintMode, -1), mActionTintMode);
        ta.recycle();//回收
    }
